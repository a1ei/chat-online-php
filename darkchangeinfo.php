...
<script src="./live2dw/lib/L2Dwidget.0.min.js"></script>
<script>
    ...
    var models = [
        ...
        "./live2dw/live2d-widget-model-chitose/assets/chitose.model.json",
        "./live2dw/live2d-widget-model-epsilon2_1/assets/Epsilon2.1.model.json",
        "./live2dw/live2d-widget-model-haru_1/assets/haru01.model.json",
        "./live2dw/live2d-widget-model-haru_2/assets/haru02.model.json",
        "./live2dw/live2d-widget-model-haruto/assets/haruto.model.json",
        ...
        "./live2dw/live2d-widget-model-unitychan/assets/unitychan.model.json",
        "./live2dw/live2d-widget-model-tororo/assets/tororo.model.json",
        "./live2dw/live2d-widget-model-nito/assets/nito.model.json",
...
<div class="background-image" style="background-image: url('images/bc.gif');"></div>
...
<div class="wrapper">
    <section class="form signup">
        ...
        ?>
        <header>ChangeInformation</header>
        <form action="php/changesuccess.php" method="POST" enctype="multipart/form-data">
            <div class="error-text"></div>
            <div class="name-details">
                <div class="field input">
                    <label>First Name</label>
                    <input type="text" name="fname" value="<?php echo htmlspecialchars($row['fname'], ENT_QUOTES, 'UTF-8'); ?>" required>
                </div>
                <div class="field input">
                    <label>Last Name</label>
                    <input type="text" name="lname" value="<?php echo htmlspecialchars($row['lname'], ENT_QUOTES, 'UTF-8'); ?>" required>
                </div>
            </div>
            <div class="field input">
                <label>Email Address</label>
                <input type="text" name="email" value="<?php echo htmlspecialchars($row['email'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="The email address cannot be changed." required>
            </div>
            <div class="field input">
            ...
            <div class="field input">
                ...
                <input type="password" name="password" placeholder="Verify new password" >
                <i class="fas fa-eye"></i>
            </div>
            ...
            <div class="field image">
                <label>Change Avatar   更换头像</label>
                <input type="file" name="image" accept="image/x-png,image/gif,image/jpeg,image/jpg"  >
            </div>
            <div class="field button">
                <input type="submit" name="submit" value="Confirm Update of Information">
            </div>
        </form>
        <div class="link"> <a href="users.php">return</a></div>
    </section>
</div>

<script src="javascript/rain.js"></script>
<script src="javascript/darkusers.js"></script>
</script>
</body>
