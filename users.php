    ...
    <section class="users">
      <header>
        <div class="content">
          ...
          ?>
            <a href="changeinformation.php" class="btn-link">
                <headbutton class="profile-link" onclick="openProfileMenu()">
                    <img src="php/images/<?php echo $row['img']; ?>" alt="User Profile Image">
                </headbutton>
            </a>
          <div class="details">
