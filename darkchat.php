    ...
    <header>
        <?php 
          ...
          if(mysqli_num_rows($sql) > 0){
            ...
            header("location: darkusers.php");
          }
        ?>
        <a href="darkusers.php" class="back-icon"><i class="fas fa-arrow-left"></i></a>
      ...
      <form action="#" class="typing-area">
        ...
        <emoButton id="emoButton">emo</emoButton>
        <button><i class="fab fa-telegram-plane"></i></button>
        
      </form>
    </section>
  </div>
  <script src="javascript/darkchat.js"></script>
